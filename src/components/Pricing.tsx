...
const Pricing = () => {
  return (
    <section 
      ...
      className="py-16"
      style={{
        backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/src/assets/coffee-beans-bg.jpg')",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="mb-6">
              Our comprehensive barista training program offers exceptional value with hands-on learning, professional equipment, and industry-recognized certification.
            </p>
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-start">
                <Check className="h-5 w-5 text-gold mr-2 mt-1 flex-shrink-0" />
                <span>Free barista toolkit for all participants</span>
              </li>
              <li className="flex items-start">
                <Check className="h-5 w-5 text-gold mr-2 mt-1 flex-shrink-0" />
